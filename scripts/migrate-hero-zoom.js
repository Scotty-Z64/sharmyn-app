// Homepage banner zoom — idempotent, safe to re-run.
// Run: node scripts/migrate-hero-zoom.js
...
async function main() {
  ...
  try {
    await tryAlter("site_settings.hero_zoom", "ALTER TABLE site_settings ADD COLUMN hero_zoom int NULL");
